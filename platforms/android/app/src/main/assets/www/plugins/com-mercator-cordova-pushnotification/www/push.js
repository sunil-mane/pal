cordova.define("com-mercator-cordova-pushnotification.PushNotification", function(require, exports, module) {
...
var PushNotification = function(options) {
    ...
    var fail = function(msg) {
        var e = (typeof msg === 'string') ? {message: msg} : msg;
        that.emit('error', e);
    };
...
Push.prototype.hasPermission = function(successCallback, errorCallback) {
    if (!errorCallback) { errorCallback = function() {}; }
    exec(successCallback, errorCallback, 'PushNotification', 'hasPermission', []);
};

Push.prototype.openSettings = function(successCallback, errorCallback) {
    if (!successCallback) { successCallback = function() {}; }
    if (!errorCallback) { errorCallback = function() {}; }
    exec(successCallback, errorCallback, 'PushNotification', 'openSettings', []);
};
