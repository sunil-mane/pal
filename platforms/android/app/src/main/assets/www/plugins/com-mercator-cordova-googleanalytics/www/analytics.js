cordova.define("com-mercator-cordova-googleanalytics.UniversalAnalytics", function(require, exports, module) {
...
UniversalAnalyticsPlugin.install = function () {
    if (!window.plugins) {
        window.plugins = {};
    }
    window.plugins.googleanalytics = new UniversalAnalyticsPlugin();
    return window.plugins.googleanalytics;
};

cordova.addConstructor(UniversalAnalyticsPlugin.install);
