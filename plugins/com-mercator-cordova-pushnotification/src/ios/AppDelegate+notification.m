...
//    NSLog(@"didRegisterUserNotificationSettings %lu", (unsigned long)notificationSettings.types);
//    if (notificationSettings.types == UIUserNotificationTypeNone) {
//        NSString *errorMessage = @"UserNotificationNone";
//        PushPlugin *pushHandler = [self getCommandInstance:@"PushNotification"];
//        [pushHandler didFailToRegisterForUserNotificationSettingsWithError:errorMessage];
//    }
//}
